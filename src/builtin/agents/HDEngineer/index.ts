...
export type HDEngineerPhase = "interview" | "design" | "full"

export const HDENGINEER_PROMPT_METADATA: AgentPromptMetadata = {
  category: "specialist",
  cost: "EXPENSIVE",
  promptAlias: "HDEngineer",
  ...
  useWhen: [
    "HArchitect has completed functional refinement and handed over to HDEngineer",
...
export function createHDEngineerAgent(model?: string) {
  return createSdkAgent(DEFINITION, model)
}

createHDEngineerAgent.mode = DEFINITION.mode
