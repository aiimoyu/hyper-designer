...
function buildBuiltinWorkflows(ctx: HyperDesignerPluginContext | undefined): Record<string, WorkflowDefinition> {
...
export const BUILTIN_PLUGIN = defineHyperDesignerPlugin(async ctx => ({
  agent: async agents => ({
    ...(agents ?? {}),
